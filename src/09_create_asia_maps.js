...
const projections = ['wgs84', 'asia_lcc'];
...
for (const filename of worldFiles) {
    ...
    for (const projection of projections) {
        const outFileName = filename.replace('admin_0_countries', projection === 'wgs84' ? 'asia' : projection);
        ...
        exportProjection(
            ...
            (feature) => feature.properties.REGION_UN === 'Asia' || feature.properties.NAME === 'Russia',
            bboxMap,
            outFilePath
        );
    }
