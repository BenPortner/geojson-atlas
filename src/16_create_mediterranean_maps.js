...
const projections = ['wgs84'];
const countries = ['Italy', 'Algeria', 'Libya', 'Egypt', 'Tunisia',]
...
for (const filename of worldFiles) {
    ...
    for (const projection of projections) {
        const outFileName = filename.replace('admin_0_countries', projection === 'wgs84' ? 'mediterranean' : projection);
        ...
        exportProjection(
            ...
            // (feature) => feature.properties.SUBREGION === 'Southern Europe' || feature.properties.SUBREGION === 'Northern Africa',
            (feature) => countries.includes(feature.properties.NAME),
            bboxMap,
            outFilePath
        );
    }
