...
for (const filename of worldFiles) {
    ...
    for (const projection of projections) {
        const outFileName = filename.replace('admin_0_countries', projection === 'wgs84' ? 'south-eastern_asia' : projection);
        ...
        exportProjection(
            ...
            (feature) => feature.properties.SUBREGION === 'South-Eastern Asia',
            bboxMap,
            outFilePath
        );
    }
