...
for (const filename of worldFiles) {
    ...
    for (const projection of projections) {
        const outFileName = filename.replace('admin_0_countries', projection === 'wgs84' ? 'caribbean' : projection);
        ...
        exportProjection(
            ...
            (feature) => feature.properties.SUBREGION === 'Caribbean' || feature.properties.NAME === 'Panama' || feature.properties.NAME === 'El Salvador',
            bboxMap,
            outFilePath
        );
    }
